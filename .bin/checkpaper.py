...
def ChkBanTerm(textsouce):
    BanlistText = [ ["予め","あらかじめ"], ["あらわす","表す"], ["表わす","表す"], ["言う","いう"], ["１次元","一次元"], ["２次元","二次元"], ["３次元","三次元"], ["幾つか","いくつか"], ["及び","および"], ["およぼす","及ぼす"], ["各々","おのおの"], ["行なう","行う"], ["行なった","行った"], ["関わる","かかわる"], ["係わる","かかわる"], ["拘わる","かかわる"], ["きわめて","極めて"], ["較べる","比べる"], ["繰返す","繰り返す"], ["組合せ","組み合わせ"], ["組替える","組み替える"], ["事","こと"], ["毎","ごと"], ["更に","さらに"], ["従って","したがって"], ["にしたがい","に従い"], ["充分","十分"], ["既に","すでに"], ["即ち","すなわち"], ["総て","すべて"], ["全て","すべて"], ["直ぐに","すぐに"], ["但し","ただし"], ["例え","たとえ"], ["たとえば","例えば"], ["つぎに","次に"], ["出来る","できる"], ["著者","筆者"], ["時に","ときに"], ["とくに","特に"], ["留まる","とどまる"], ["止まる","とどまる"], ["伴なう","伴う"], ["無い","ない"], ["等","など"], ["並びに","ならびに"], ["を始めとして","をはじめとして"], ["１つ","一つ"], ["２つ","二つ"], ["ひとり","一人"], ["殆ど","ほとんど"], ["又は","または"], ["全く","まったく"], ["稀","まれ"], ["充たす","満たす"], ["むずかしい","難しい"], ["もとづく","基づく"], ["尤も","もっとも"], ["もっとも","最も"], ["し易い","しやすい"], ["呼ぶ","よぶ"], ["様だ","ようだ"], ["ゆく","いく"], ["解る","分かる"], ["判る","分かる"], ["僅か","わずか"], ["われわれ","我々"]  ]
