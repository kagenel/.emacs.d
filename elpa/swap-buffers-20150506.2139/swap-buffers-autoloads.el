;;; swap-buffers-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(autoload 'swap-buffers-dired-find-file "swap-buffers" "\


\(fn)" t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "swap-buffers" '("swap-buffers-")))

;;;***

;;;### (autoloads nil nil ("swap-buffers-pkg.el") (0 0 0 0))
